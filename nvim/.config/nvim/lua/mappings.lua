...
map("n", "H", "<cmd>bprev<CR>", {desc = "Switch to the previous buffer"})
map("n", "L", "<cmd>bnext<CR>", {desc = "Switch to the next buffer"})
map("n", "<leader>q", "<cmd>bdelete<CR>", {desc = "Kill current buffer"})

-- Pane navigation
map("n", "<C-k>", "<C-w>k", {noremap = true, desc = "Switch to the above pane"})
map("n", "<C-j>", "<C-w>j", {noremap = true, desc = "Switch to the below pane"})
map("n", "<C-l>", "<C-w>l", {noremap = true, desc = "Switch to the left pane"})
map("n", "<C-h>", "<C-w>h", {noremap = true, desc = "Switch to the right pane"})
