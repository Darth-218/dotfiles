...
// static       int smartgaps          = 8;        /* 1 means no outer gap when there is only one window */
...
static const Layout layouts[] = {
	...
	{ " ",      NULL },    /* no layout function means floating behavior */ { " ",      monocle }, /* { "[@]",      spiral },
	{ "[\\]",     dwindle },
	{ "H[]",      deck },
	{ "TTT",      bstack },
	{ "===",      bstackhoriz },
...
static Keychord *keychords[] = {
       ...
       /* Lockscreen */
       &((Keychord){1, {{MODKEY, XK_s}},                                                  spawn,          {.v = lockscrn } }),
};
