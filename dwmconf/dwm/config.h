...
static const char col_gray3[] = "#4d4d4d";
static const char col_gray4[] = "#eeeeee";
static const char col_gold[] = "#c4b28a";
static const char col_purple[] = "#f9d791";
static const char *colors[][3] = {
    /*               fg         bg          border   */
    [SchemeNorm] = {col_gray3, col_gray1, col_gray2},
    [SchemeSel] = {col_gold, col_gray1, col_purple},
};

/* tagging */
static const char *tags[] = {"[1:  ]",  "[2: 󰈹 ]", "[3:  ]",
                             "[4: 󰇰 ]", "[5: 󰎅 ]", "[6:  ]",
                             "[7:  ]",  "[8: 󰰱 ]", "[9: 󰰷 ]"};
...
/* Lock the screen*/
static const char *lockscrn[] = {"betterlockscreen", "-l", "blur", "0.0", NULL};

/* Screenshot */

// Full desktop screenshot
static const char *fulldeskss[] = {"spectacle", "-fc", NULL};
// Active monitor screenshot
static const char *activemss[] = {"spectacle", "-mc", NULL};
// Active window screenshot
static const char *activewss[] = {"spectacle", "-ac", NULL};
// Region screenshot
static const char *regionss[] = {"spectacle", "-rc", NULL};
